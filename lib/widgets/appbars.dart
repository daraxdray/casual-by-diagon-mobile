...
Widget homeAppBar(context, UserProvider userProvider) {
  return Container(
      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                Positioned(
                    ...
                    child: DgClickable(
                      child: CommonImageView(
                          ...
                          width: 33),
                      onTap: () => Get.toNamed(
                          DgRoutes.authRoute(DgRoutes.userProfileScreen)),
                    )),
                Positioned(
                    top: 9,
                    left: 0,
        ...
        DgClickable(
            onTap: () =>
                Get.toNamed(DgRoutes.authRoute(DgRoutes.userProfileScreen)),
            child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                        "${userProvider.dgAuthService.getAuthProfile().getTicket}",
            ...
            child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                        "${userProvider.dgAuthService.getAuthProfile().getPoint}",
                        style: const TextStyle(
                            color: Colors.white, fontWeight: FontWeight.bold)),
                    const SizedBox(width: 5),
                    Image.asset(
