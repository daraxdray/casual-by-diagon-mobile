...
class GameStartScreen extends GetWidget<GameStartScreenController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                  ...
                  children: [
                    ...
                    Positioned(
                        ...
                        child: Container(
                            ...
                            child:  Center(
                                child: Text("${controller.dgAuthService.getAuthProfile().getRank().level}",
        ...
        body:  Container(
          decoration: BoxDecoration(
            image: const DecorationImage(image:AssetImage("assets/img/red_lightning_bg.png"),fit: BoxFit.cover)
          ),
